...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default=None, help="path to the original model directory (for config metadata).")
    ...
    if model_type == "qwenimage" and args.model_path:
        ...
        metadata = {
            ...
            "quantization_config": _json.dumps(quant_config),
        }
    ...
    safetensors.torch.save_file(
        ...
        os.path.join(output_dirpath, "transformer_blocks.safetensors"),
        metadata=metadata,
    )
