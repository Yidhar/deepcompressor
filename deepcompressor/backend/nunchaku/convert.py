...
def convert_to_nunchaku_qwenimage_transformer_block_state_dict(
    ...
    return convert_to_nunchaku_transformer_block_state_dict(
        ...
        local_name_map={
            ...
            "out_proj": "attn.to_out.0",
            "out_proj_context": "attn.to_add_out",
            "mlp_fc1": "img_mlp.net.0.proj",
            "mlp_fc2": img_down_proj_local_name,
            "mlp_context_fc1": "txt_mlp.net.0.proj",
            "mlp_context_fc2": txt_down_proj_local_name,
        },
        smooth_name_map={
            "qkv_proj": "attn.to_q",
            "qkv_proj_context": "attn.add_k_proj",
        ...
        convert_map={
            "img_mod.1": "adanorm_zero",
            "txt_mod.1": "adanorm_zero",
            "qkv_proj": "linear",
            "qkv_proj_context": "linear",
            "out_proj": "linear",
            "out_proj_context": "linear",
...
if __name__ == "__main__":
    ...
    assert "flux" in model_name_lower or "qwen-image" in model_name_lower, (
        "Only Flux and QwenImage models are supported."
    )
    ...
    if "qwen-image" in model_name_lower:
